namespace ArduinoClient
{
	partial class NewUsuario
	{
		...
		private void InitializeComponent()
		{
			...
			this.dateTimePicker1.CalendarTitleForeColor = System.Drawing.Color.Magenta;
			...
			this.lblCodigo.Location = new System.Drawing.Point(84, 56);
			...
			this.label13.Text = "Escanea para asignar Llavero";
			// 
			// NewUsuario
			// 
			...
			this.Text = "Usuario";
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.NewUsuario_FormClosed);
